...
q_a.insertMany([
    ...
    {question: "Point out the error in the following program (if it is compiled with Turbo C compiler). img src", option1: "(a)	No error", option2: "(b) display() doesn't get invoked", option3: "(c) display() is called before it is defined", option4: "(d)	None of these", c_option: "(c) display() is called before it is defined"},
    {question: "Point out the error in the following program.", option1: "(a) Error: Declaration syntax error 'v' (or) Size of v is unknown or zero.", option2: "(b) Program terminates abnormally.", option3: "(c)	No error.", option4: "(d) None of these.", c_option: "(a) Error: Declaration syntax error 'v' (or) Size of v is unknown or zero."},
    ...
    {question: "What is the output of the following code snippet? image", option1: "(a) x is 10  ", option2: "(b) x is not 10  ", option3: "(c) Compiler Error  ", option4: "(d) Runtime Error  ", c_option: "(a) x is 10  "},
    ...
    {question: "What is the output of the following code snippet? image", option1: "(a) 5, 7  ", option2: "(b) 5, 6  ", option3: "(c) 6, 7  ", option4: "(d) 6, 6  ", c_option: "(c) 6, 7  "},
    {question: "What will be the output of the following code? image", option1: "(a) Hello  ", option2: "(b) Compiler Error  ", option3: "(c) Undefined behavior  ", option4: "(d) Null character  ", c_option: "(d) Null character  "},
    ...
    {question: "What is the output of the following code snippet? image", option1: "(a) 5 6 7  ", option2: "(b) 7 6 5  ", option3: "(c) 6 7 5  ", option4: "(d) Compiler Error  ", c_option: "(c) 6 7 5  "},
    ...
    {question: "What is the output of the following code snippet? image", option1: "(a) 0 1 2 3 4  ", option2: "(b) 0 1 2 3  ", option3: "(c) 1 2 3 4 5  ", option4: "(d) Infinite loop  ", c_option: "(a) 0 1 2 3 4  "},
    ...
    {question: "What will be the output of the following code? image ", option1: "(a) 1  ", option2: "(b) 2  ", option3: "(c) 3  ", option4: "(d) 4  ", c_option: "(c) 3  "},
    {question: "What is the output of the following code snippet? image", option1: "(a) 0  ", option2: "(b) 10  ", option3: "(c) Address of x  ", option4: "(d) Compiler Error  ", c_option: "(b) 10  "},
    ...
    {question: "What is the output of the following code snippet? image", option1: "(a) H  ", option2: "(b) e  ", option3: "(c) Hello  ", option4: "(d) Compiler Error  ", c_option: "(a) H  "},
